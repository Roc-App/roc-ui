  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>维新后台管理框架</h2>
        <p>
          维新可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
        </p>
        <p>
          <b>当前版本:</b> <span>v{{ version }}</span>
        </p>
        <p>
          <el-tag type="danger">原版系统</el-tag>
        </p>
        <p>
          <el-button
            type="primary"
          ...
          <el-button
            ...
            icon="el-icon-s-home"
            plain
            @click="goTarget('http://www.baidu.com')"
          >访问主页</el-button>
        </p>
      </el-col>
    ...
    <el-row :gutter="20">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion" /> 官网：<el-link
                ...
                target="_blank"
              >http://www.baidu.com</el-link>
            </p>
            <p>
              <i class="el-icon-user" /> 微信：<el-link
                target="_blank"
              >wkp19971010ooo</el-link>
            </p>
            <p>
              <i class="el-icon-user" /> QQ：<el-link
                target="_blank"
              >3455211435</el-link>
            </p>
          </div>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <img
              src="@/assets/contactInfo/QQ.jpg"
              alt="donate"
              width="50%"
            >
            <img
              src="@/assets/contactInfo/weixin.png"
              alt="donate"
              width="50%"
            >
            <span
